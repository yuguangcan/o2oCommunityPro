...
{%block name="css"%}
<!-- build:css(.tmp) /static/community/styles/page/ucenter-likeactivity.css -->
<link rel="stylesheet" href="static/styles/page/ucenter-likeactivity.css">
<!-- endbuild -->
{%/block%}

{%block name="header"%}
	{%include file="community/widget/header.tpl" headertitle="已收藏"%}
{%/block%}
...
<!-- endbuild -->
<!-- build:js /static/community/scripts/page/ucenter-likeactivity.js -->
<script src="static/scripts/page/ucenter-likeactivity.js"></script>
<!-- endbuild -->
{%/block%}
